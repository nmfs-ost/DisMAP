...
def main(project="", test=False):
    try:
        ...
        try:
            ...
            # "SEUS_FAL_IDW", "SEUS_SPR_IDW", "SEUS_SUM_IDW", "WC_GLMME", "WC_ANN_IDW", "WC_TRI_IDW",
...
##                results.extend(result); del result
                ...
                result = director(project_gdb=project_gdb, Sequential=False, table_names=["WC_TRI_IDW", "GMEX_IDW", "AI_IDW",])
                results.extend(result); del result
...
if __name__ == '__main__':
    try:
        ...
        import create_rasters_director
        importlib.reload(create_rasters_director)
