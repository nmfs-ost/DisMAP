...
def main():
    ...
    #print(etree.tostring(_eainfo_root, pretty_print=True, encoding="utf-8").decode())

    eainfo_xml_file = r'C:\Users\john.f.kennedy\Documents\ArcGIS\Projects\ArcPy Studies\XML\nmfs-species-range-metatdata\eainfo.xml'
