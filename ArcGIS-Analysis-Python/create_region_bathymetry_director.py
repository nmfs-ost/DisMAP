...
def director(project_gdb="", Sequential=True, table_names=[]):
    try:
        ...
        del create_region_bathymetry_worker
        ...
        if results:
            ...
            for result in results:
                ...
                elif data_type in ["FeatureClass", "Table", "RasterDataset"]:
...
if __name__ == '__main__':
    try:
        ...
        import create_region_bathymetry_director
        importlib.reload(create_region_bathymetry_director)
