...
**The Species Persistence module is in a pilot period. Feedback is encouraged and can always be given by submitting a pull request through GitHub or emailing [dismap.contact@noaa.gov](dismap.contact@noaa.gov).**
...
We also tallied the amount of years that a species was absent or present in a particular survey.
...
# creating an object with all four columns above for each species in a particular survey
data_ce_ap <- data_ce %>% 
