...
def main():
    try:
        ...
        # East Coast        = N 46 W -82 S 28 E -64   - NEUS_F, NEUS_S, SEUS_SPR, SEUS_SUM, SEUS_FALL
        # West Coast WC_ANN = N 50 W -130 S 29 E -118 - WC_ANN
        # West Coast WC_TRI = N 50 W -131 S 35 E -117 - WC_TRI
...
##                      }
        ...
        dismap_dict = {
                       ...
                       'WC_ANN' : 'gebco_2021_n50.0_s29.0_w-131.0_e-117.0.asc',
